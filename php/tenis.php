...
// Obtener las pistas de Tenis (id_deporte = 3)
$sql_pistas = "SELECT * FROM pistas WHERE id_deporte = 3";
...
<head>
    ...
    <title>Reserva Tenis - San Isidro</title>
...
<body>
    ...
    <header class="hero-deporte-base hero-tenis">
        <h1>Pistas de Tenis</h1>
        <p>Disfruta de nuestras pistas de tierra batida y superficies rápidas para tus mejores partidos.</p>
    </header>
    ...
    <main class="contenido-deporte">
        ...
        <section class="reserva-futura" style="margin-top: 40px;">
            ...
            <form action="tenis.php" method="GET" class="formulario-fecha">
